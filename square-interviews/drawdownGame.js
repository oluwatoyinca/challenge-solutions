...
Simulate all possible gameplays and return the total number of times each player could possibly win if every possible move combinations are used.
*/
...
console.log(myn.playGame(), `Player 1 can win ${myn.playGame()[0]} time(s) and Player 2 can win ${myn.playGame()[1]} time(s)`)
